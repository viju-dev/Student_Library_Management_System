...
import com.example.Student_Library_Management_System.Repositories.AuthorRepo;
...
public class BookService {
    ...
    public String addBook(BookRequestDto bookRequestDto){
        ...
        //We need to update the listOfBooks written in the parent clas

        List<Book> currentBooksWritten = author.getBookList();
